                ...
                <div className='max-w-6xl mx-auto'>
                    ...
                    <div className='text-center mb-28'>
                        <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}
                            className='text-4xl md:text-4xl font-semibold leading-tight max-w-4xl mx-auto'>
                        ...
                        <motion.p initial={{ opacity: 0 }} animate={{ opacity: 1 }} transition={{ duration: 0.8 }}
                            ...
                            Role-based mock interviews with smart follows-ups, adaptive difficulty and real-time performance evaluation
                        </motion.p>
                    ...
                    <div className='flex flex-col md:flex-row justify-center items-center gap-10 mb-28'>
                        {
                            [
                                ...
                                <motion.div key={index} initial={{ opacity: 0, y: 60 }} whileInView={{ opacity: 1, y: 0 }}
                                    transition={{ duration: 0.6 + index * 0.2 }} whileHover={{ rotate: 0, scale: 1.06 }}
                        ...
                        <div className='grid md:grid-cols-2 gap-10'>
                            {
                                [
                                    ...
                                    },
                                    {
                                        ...
                                        desc: "Track progress with performace graphs and topic analysis."
                                    }
                                ].map((item, index) => (
