            ...
            className = 'w-full max-w-6xl bg-white rounded-[24px] shadow-sm border border-gray-200 px-8 py-4 flex justify-between items-center relative'>
                ...
                <div className = 'flex items-center gap-6 relative'>
                    <div className = 'relative'>
                        <button onClick = {()=>{if(!userData){ setShowAuth(true); return;}; setShowCreditPopup(!showCreditPopup); setShowUserPopup(false)}}
                    ...
                    <div className = 'relative'>
                        <button onClick = {()=>{if(!userData){ setShowAuth(true); return;}; setShowUserPopup(!showUserPopup); setShowCreditPopup(false)}}
